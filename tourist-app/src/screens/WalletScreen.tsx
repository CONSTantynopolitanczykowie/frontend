...
import { REWARDS, Reward } from '../data/mockData';
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.summaryGradient}>
            ...
            <View style={styles.levelBadge}>
              ...
              <View>
                ...
                <Text style={styles.levelSub}>Odwiedź 5 luźnych wejść → Złoty Surfer</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statBox}>
            ...
            <Text style={styles.statBoxLabel}>Wybrałem luźną plażę</Text>
          </View>
          <View style={styles.statBox}>
          ...
          {rewards.filter((r) => !r.used).length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyDesc}>
                Wybierz luźniejsze wejście na plażę, gdy kliknie "tłok", by zdobyć nagrody!
              </Text>
            </View>
          ) : (
            rewards.filter((r) => !r.used).map((reward) => (
              <RewardCard key={reward.id} reward={reward} onUse={handleUse} />
            ))
          )}
        </View>
        ...
        <View style={styles.howToCard}>
          ...
          {[
            ...
            { icon: '🗺', text: 'Wybierz opcję "Prowadź na luźną plażę"' },
